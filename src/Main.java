...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        jsonWriter.writeInJSONFile(metro.getMetroObject(), "resourse/metro.json");
        JSONReader jsonReader = new JSONReader();
        jsonReader.getAmountOfStations("resourse/metro.json");

        DataCollector collector = new DataCollector();
        collector.fileReader("resourse/data");
        ...
        jsonWriter1.writeInJSONFile(stationObject, "resourse/stations.json");
    }
